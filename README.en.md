...
> This repository evolves from [xmanrui/dsh-im](https://github.com/xmanrui/dsh-im) and is published as `@tokens/dsh-connect`. The original authorship, contribution history, and MIT license are preserved. The current package combines IM bots with personal Feishu and DingTalk authorization in one TokensHarness Connection Center.
