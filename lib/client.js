...
var CAPABILITY_STATE_TEXT = Object.freeze({
  available: "\u53EF\u7528",
  local_only: "\u5DF2\u5B89\u88C5",
  missing_scope: "\u7F3A\u5C11\u6743\u9650",
  disconnected: "\u672A\u8FDE\u63A5",
...
var STATUS_CACHE = /* @__PURE__ */ new WeakMap();
var STATUS_REQUESTS = /* @__PURE__ */ new WeakMap();
function cachedFeishuPersonalStatus(rpcCall) {
  return STATUS_CACHE.get(rpcCall);
}
function cacheFeishuPersonalStatus(rpcCall, status) {
...
function preloadFeishuPersonalStatus(rpcCall, { refresh = false } = {}) {
  ...
  const request = fetchFeishuPersonalStatus(rpcCall).then((status) => cacheFeishuPersonalStatus(rpcCall, status)).finally(() => {
    ...
    h2(
      ...
      h2(
        ...
        h2(
          ...
          null,
          h2("h3", null, "\u5B9E\u9645\u80FD\u529B"),
          h2("p", null, "\u6839\u636E\u5F53\u524D\u8D26\u53F7\u7684\u5B9E\u9645\u6743\u9650\u4E0E\u672C\u673A\u7EC4\u4EF6\u751F\u6210")
        )
      ),
      capabilities.length > 0 ? h2("div", { className: "dfp-capabilityList" }, capabilities.map((capability) => {
        const enabled = capability.state === "available";
        return h2(
          "div",
          { className: "dfp-capability", key: capability.id, "data-state": capability.state },
          h2("span", { className: "dfp-capabilityMark", "data-on": String(enabled) }, enabled ? "\u2713" : "\xB7"),
          h2(
            "span",
            { className: "dfp-capabilityCopy" },
            h2("strong", null, capability.name),
            h2("code", null, capability.provider),
            h2("small", null, capability.detail),
            h2("small", { className: "dfp-capabilitySource" }, `\u4F9D\u636E\uFF1A${capability.source}`)
          ),
          h2(
            "small",
            { className: "dfp-capabilityState" },
            CAPABILITY_STATE_TEXT[capability.state] ?? "\u672A\u77E5"
          )
        );
      })) : h2("div", { className: "dfp-emptyFact" }, "\u7B49\u5F85\u6388\u6743\u72B6\u6001\u68C0\u6D4B")
    ),
    h2(
      "section",
      { className: "dfp-section" },
      ...
      domains.length > 0 ? h2("div", { className: "dfp-scopeDomains", "aria-label": "\u98DE\u4E66\u4E2A\u4EBA\u6743\u9650\u80FD\u529B\u57DF" }, domains.map((domainItem) => h2("span", { key: domainItem.id }, h2("span", null, domainItem.name), ` ${domainItem.count}`))) : null,
      ...
      h2("p", { className: "dfp-evidenceNote" }, "\u5E94\u7528\u8EAB\u4EFD\u4EC5\u9A8C\u8BC1\u51ED\u636E\u53EF\u7528\u6027\uFF1B\u5177\u4F53\u5E94\u7528\u6743\u9650\u4F1A\u5728\u80FD\u529B\u8C03\u7528\u65F6\u7531\u98DE\u4E66\u518D\u6B21\u6821\u9A8C\u3002")
    )
  );
}
function FeishuPersonalSettings({ rpcCall }) {
  const initialStatus = cachedFeishuPersonalStatus(rpcCall);
  const initiallyCached = React19.useRef(initialStatus !== void 0);
