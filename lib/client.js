...
function deriveFeishuPersonalView(status) {
  ...
  const actionHref = !connected && phase === "creating" ? safeFeishuPersonalHref(status?.qrUrl) : !connected && phase === "authorizing" ? safeFeishuPersonalHref(status?.authorizeUrl) : void 0;
      ...
      h2(
        ...
        h2(
          ...
          h2(
            "div",
            null,
            h2("h3", null, connected ? "\u4E2A\u4EBA\u8FDE\u63A5" : "\u63A5\u5165\u65B9\u5F0F"),
            h2("p", null, statusMessage(status))
          )
        ),
        !connected && !connecting ? h2(
          "div",
        ...
        !connecting ? h2(
          ...
          h2(
            ...
            h2("strong", null, "\u98DE\u4E66\u5E94\u7528"),
            h2("small", null, connected ? "\u5207\u6362\u5E94\u7528\u4F1A\u91CD\u65B0\u8FDB\u884C\u4E2A\u4EBA\u6388\u6743" : "\u673A\u5668\u4EBA\u4E0E\u4E2A\u4EBA\u6388\u6743\u53EF\u4EE5\u590D\u7528\u540C\u4E00\u4E2A\u5E94\u7528")
          ),
          h2(
            "select",
            {
        ...
        h2(
          ...
          !connected && !connecting ? h2("button", {
...
function IMSettingsTab({
  ...
  const [activeGroupId, setActiveGroupId] = React20.useState(CHANNEL_GROUPS[0].id);
  const [loopbackRecovery, setLoopbackRecovery] = React20.useState(null);
  const githubTooltipId = React20.useId();
  const groupTabsId = React20.useId();
  const groupTabRefs = React20.useRef([]);
