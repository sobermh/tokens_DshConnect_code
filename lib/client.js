...
var EN = Object.freeze({
  ...
  "\u7EDF\u4E00\u7BA1\u7406\u6D88\u606F\u901A\u9053\u4E0E\u670D\u52A1\u8FDE\u63A5": "Manage message channels and service connections in one place",
...
var OFFICE_STYLE_ID = "tokens-dsh-connect-office-settings";
var CSS5 = `
...
function FeishuPersonalSettings({ rpcCall }) {
  ...
  React20.useEffect(() => {
    if (status?.phase !== "creating" && status?.phase !== "authorizing") return void 0;
  ...
  const actionHref = phase === "creating" ? safeFeishuPersonalHref(status?.qrUrl) : phase === "authorizing" ? safeFeishuPersonalHref(status?.authorizeUrl) : void 0;
  return h2(
    "section",
    ...
    tab === "connection" ? h2(
      ...
      h2(
        ...
        h2(
          ...
          }, busy === "connect" ? "\u6B63\u5728\u542F\u52A8..." : status?.appConfigured ? "\u7EE7\u7EED\u6388\u6743" : "\u4E00\u952E\u8FDE\u63A5") : null,
          connected ? h2("button", {
            className: "dfp-button",
            type: "button",
            disabled: busy !== void 0,
      ...
      h2(
        ...
        h2(
          ...
          h2("div", null, h2("dt", null, "\u5E94\u7528"), h2("dd", null, status?.appConfigured ? status.appName : "\u672A\u914D\u7F6E")),
          h2("div", null, h2("dt", null, "\u4E2A\u4EBA\u8D26\u53F7"), h2(
            "dd",
            null,
            status?.userAuthorized ? status.userName ?? "\u5DF2\u6388\u6743\u8D26\u53F7" : "\u672A\u6388\u6743"
          )),
          h2("div", null, h2("dt", null, "\u672C\u673A\u914D\u7F6E"), h2(
            "dd",
            null,
            h2("code", null, status?.profile ?? "dsh-feishu")
          ))
        )
      )
    ) : h2(
      ...
      h2(
        ...
        h2(
          "div",
          { className: "dfp-sectionHead" },
          h2("div", null, h2("h3", null, "\u53EF\u7528\u80FD\u529B"), h2("p", null, "\u8FDE\u63A5\u540E\uFF0CAgent \u53EF\u4EE5\u6309\u9700\u8C03\u7528\u8FD9\u4E9B\u98DE\u4E66\u5DE5\u5177"))
        ),
        h2("div", { className: "dfp-capabilityList" }, CAPABILITIES.map((capability) => h2(
          "div",
          { className: "dfp-capability", key: capability.tool },
          h2("span", { className: "dfp-capabilityMark", "data-on": String(connected) }, connected ? "\u2713" : "\xB7"),
          h2("span", null, h2("strong", null, capability.name), h2("code", null, capability.tool)),
          h2("small", null, connected ? "\u53EF\u7528" : "\u8FDE\u63A5\u540E\u542F\u7528")
        )))
      ),
      h2(
        "section",
        ...
        h2(
          "div",
          { className: "dfp-sectionHead" },
          h2("div", null, h2("h3", null, "\u6388\u6743\u72B6\u6001"), h2("p", null, "\u9996\u6B21\u521B\u5EFA\u5E94\u7528\u65F6\u4F1A\u9884\u586B\u6240\u9700\u7684\u79DF\u6237\u548C\u4E2A\u4EBA\u6743\u9650"))
        ),
        h2(
          "div",
          { className: "dfp-permissionSummary" },
          h2("span", { "data-on": String(status?.appConfigured === true) }, "\u5E94\u7528\u6743\u9650"),
          h2("span", { "data-on": String(status?.userAuthorized === true) }, "\u4E2A\u4EBA\u6743\u9650"),
          h2("span", { "data-on": String(connected) }, "\u5B98\u65B9 Skills")
        )
      )
    )
  );
...
.dim-brandName { color: var(--dsw-alias-label-primary, #1f2329); font-size: 20px; line-height: 24px; font-weight: 760; letter-spacing: 0; }
...
.dim-rail { max-height: 560px; display: grid; align-content: start; gap: 16px; overflow-y: auto; padding: 1px 4px 1px 1px; scrollbar-width: thin; scrollbar-color: var(--dsw-alias-border-l2, #dfe1e5) transparent; }
...
.dim-channelGroupLabel { padding: 0 8px; color: var(--dsw-alias-label-tertiary, #8f959e); font-size: 10px; line-height: 16px; font-weight: 650; }
...
.dim-divider { width: 1px; min-height: 560px; background: var(--dsw-alias-border-l1, #eef0f3); }
  ...
  return h2(
    ...
    h2(
      ...
      h2(
        ...
        h2(
          "nav",
          { className: "dim-rail", role: "tablist", "aria-label": "\u8FDE\u63A5\u901A\u9053" },
          CHANNEL_GROUPS.map((group) => h2(
            "div",
            {
              key: group.id,
            ...
            h2("div", { className: "dim-channelGroupLabel" }, group.label),
            group.channels.map((channel4) => h2(
              "button",
              {
                key: channel4.id,
                type: "button",
